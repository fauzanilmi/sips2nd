    ...
    <body>
        ...
        <div id="wrapper">
          ...
          <ul class="nav navbar-right navbar-top-links">
                   ...
                   <li class="dropdown">
                       <a href="<?php echo base_url() ?>Login/user_logout" onclick="return confirm('Apakah anda yakin akan keluar?')" >
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        ...
                        <li>
                            ...
                            <li>
                                <a href="<?php echo base_url(); ?>/beranda/skeluar"  class="active"><i class="fa fa-table fa-fw"></i> Surat Keluar</a>
                            </li>
...
">
  	                ...
  	                <div class="pull-right">
                          <h1>
                    <button class="btn btn-primary" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i> Tambah Surat Keluar</button>
                
                    <?php echo anchor(site_url('tb_surat_keluar/excel'), 'Excel', 'class="btn btn-primary"'); ?>
		            <?php echo anchor(site_url('tb_surat_keluar/word'), 'Word', 'class="btn btn-primary"'); ?>  </h1>
  	                </div>
  	            </div>
...
function edit_person(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('SuratKeluar/ajax_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('[name="waktu_input"]').datepicker('update',data.waktu_input);
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('SuratKeluar/ajax_add')?>";
    } else {
        url = "<?php echo site_url('SuratKeluar/ajax_update')?>";
    }
...
function delete_person(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('SuratKeluar/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="tgl_surat" placeholder="yyyy-mm-dd" class="form-control datepicker" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="waktu_input" placeholder="yyyy-mm-dd" class="form-control datepicker" type="text" >
                                <span class="help-block"></span>
                            </div>
                        </div>
