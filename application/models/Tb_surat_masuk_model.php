...
class Tb_surat_masuk_model extends CI_Model
{
	...
	$this->db->or_like('tanggal_surat_diterima', $q);
	$this->db->or_like('foto_surat', $q);
...
/* End of file Tb_surat_masuk_model.php */
/* Location: ./application/models/Tb_surat_masuk_model.php */
